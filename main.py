    ...
    if selected_folder_path:
        ...
        for filename in os.listdir(selected_folder_path):
            ...
            if filename.endswith(".mid"):
                lbox.sert(tk.END, filename)
            if filename.endswith(".midi"):
                lbox.sert(tk.END, filename)  # The midi files don't load in bongo       
...
l_music_player = tk.Label(window, text="Bongo the music player", font=("TkDefaultFont", 30, "bold"))
